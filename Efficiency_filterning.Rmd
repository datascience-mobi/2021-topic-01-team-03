...
wss <- sapply(1:8, function(k){
  kmeans(x=t(medulloblastoma_ae_d7), centers = k)$tot.withinss
})
plot(1:8,wss,type = 'b',pch = 19, main = "Medulloblastoma", xlab = "Number of clusters K",
...
mb_cluster <-  kmeans(x=t(gb7), centers = 2, nstart =10)
class(mb_cluster)
#mb_cluster$cluster
...
library(ggplot2)
ggplot() +
  geom_point(mapping = aes(x = effective_g7_mean, y = not_effective_g7_mean))
