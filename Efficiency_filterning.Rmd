...
plot(astrocytoma_ae_d7_mean)

glioma_ae_d7_mean = colMeans(glioma_ae_d7)
plot(glioma_ae_d7_mean)

glioblastoma_ae_d7_mean = colMeans(glioblastoma_ae_d7)
plot(glioblastoma_ae_d7_mean)

medulloblastoma_ae_d7_mean = colMeans(medulloblastoma_ae_d7)
plot(medulloblastoma_ae_d7_mean, col = "blue") 

means_eff <- data.frame(astrocytoma_ae_d7_mean, glioma_ae_d7_mean, glioblastoma_ae_d7_mean, medulloblastoma_ae_d7_mean)

library(ggplot2)

ggplot(means_eff, aes(means_eff)) +                    
  geom_line(aes(y=astrocytoma_ae_d7_mean), colour="red") +  
  geom_line(aes(y=glioblastoma_ae_d7_mean), colour="green")
  geom_line(aes(y=glioma_ae_d7_mean), colour="blue") +  
  geom_line(aes(y=medulloblastoma_ae_d7_mean), colour="yellow")
