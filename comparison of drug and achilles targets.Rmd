...
```{r}
brain_cancer.effective_targets <- as.character(brain_cancer.effective_targets)

for(i in brain_cancer.effective_targets){
...
y <- 0
for(i in brain_cancer.effective_targets){
  for(j in brain_cancer_achilles.relevant){
    
    if(brain_cancer.effective_targets[i] == brain_cancer_achilles.relevant[j]){x = x+1}
    
    else if(brain_cancer.effective_targets[i] != brain_cancer_achilles.relevant[j]){y = y+1}
  }
}
length(brain_cancer.effective_targets)*length(brain_cancer_achilles.relevant)
x
y
