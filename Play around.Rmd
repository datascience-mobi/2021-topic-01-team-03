...
sum(rowSums(is.na(brain_cancer_exp_w))==0)
sum(rowSums(is.na(non_bc_exp))==0)
#no NAs found
...
#for(i in 1:34){
  #min_bc[i]<-min(brain_cancer_exp[i,][which(brain_cancer_exp[i,]>0)])
#}
#pseudo_value<-min(min_bc)

#brain_cancer_exp_w<-brain_cancer_exp+pseudo_value
...
#brain_cancer_exp_w=brain_cancer_exp_w[names,]
