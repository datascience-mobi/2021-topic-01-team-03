...
```{r}
#df[,2]=log2(fold_change)
fold_change=non_bc_exp_mean/bc_exp_mean
remove=which(fold_change==-Inf)
fold_change=fold_change[-remove]
#df=df[-remove,]
min(fold_change)
fold_change=fold_change+27.32736
which(fold_change<0)
```
