...
```{r}
hist(apply(brain_cancer_exp,2,var),breaks=100,xlim = range(0,6))
hist(apply(brain_cancer_cnv,2,var),breaks=100,xlim = range(0,2))

median(apply(brain_cancer_exp,2,var))

length(which(apply(brain_cancer_exp,2,var)>2.5))
```
