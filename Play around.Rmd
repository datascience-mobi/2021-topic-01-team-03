...
```{r}
no_keep_drugs=colnames(deviation[,-keep])

brain_cancer[,no_keep_drugs]
#brain_cancer=brain_cancer[,-no_keep_drugs] #WHY?! dataframe with drugs that we dont wanna keep. find a way to remove them from dataframe brain_cancer
