...
brain_cancer_exp_w=as.data.frame(scale(as.matrix(brain_cancer_exp_w)))
...
```{r}
yyy=prism.exp[non_bc_names,]
View(yyy[,b_correction])
View(brain_cancer_exp[,b_correction])
volcano_bc=brain_cancer_exp_w[,b_correction]
...
non_bc_exp_mean=apply(volcano_non_bc,2,mean)
df[,2]=log2(abs(non_bc_exp_mean/bc_exp_mean))
