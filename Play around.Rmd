...
effective_bc_treat=brain_cancer_treat[effective_in_all_doses,-c(1,2,3,4,10)]# lol this was Cedrik's task, right?
...
#IDH1_cnv= IDH1_cnv[,-which(colnames(IDH1_cnv) %in% c("IDH1.AS1"))] # why isn't this working :(
